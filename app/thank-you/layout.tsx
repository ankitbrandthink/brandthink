...
export const metadata: Metadata = {
  title: 'Thank You - BrandThink',
  description: 'Thanks for filling up the form. We will be reaching out to you shortly.',
  robots: { index: false, follow: true },
  alternates: { canonical: 'https://thebrandthink.com/thank-you/' },
  openGraph: {
    locale: 'en_US',
    type: 'article',
    title: 'Thank You - BrandThink',
    description: 'Thanks for filling up the form. We will be reaching out to you shortly.',
    url: 'https://thebrandthink.com/thank-you/',
    siteName: 'BrandThink',
    images: [{ url: 'https://thebrandthink.com/wp-content/uploads/2025/04/BrandThink-Logo.png', width: 1080, height: 1080, type: 'image/png' }],
  },
...
export default function ThankYouLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className={`${outfit.variable} ${montserrat.variable} ${kanit.variable}`}>
      {/* ── Base tracking (must load before conversion events below) ── */}
      ...
      <Script id="gads-conversion" strategy="afterInteractive">{`
        gtag('event', 'conversion', { 'send_to': 'AW-11298616134/TyV4CPbEnsMcEMbmzIsq' });
      `}</Script>
