...
export const metadata: Metadata = {
  title: 'Best Performance Marketing Agency in Pune | Get A Quote Now',
  description:
    'Top performance marketing agency in Pune delivering measurable ROI through Google Ads, Meta Ads, and data-driven paid media campaigns.',
  robots: {
    index: true,
    follow: true,
  ...
  alternates: {
    canonical: 'https://thebrandthink.com/performace-marketing-agency-in-pune/',
  },
  openGraph: {
    locale: 'en_US',
    type: 'article',
    ...
    description:
      'Top performance marketing agency in Pune delivering measurable ROI through Google Ads, Meta Ads, and data-driven paid media campaigns.',
    url: 'https://thebrandthink.com/performace-marketing-agency-in-pune/',
    siteName: 'BrandThink',
    images: [
      {
