...
export const metadata: Metadata = {
  title: 'Best Performance Marketing Agency in Bangalore | Get A Quote Now',
  description:
    'Top performance marketing agency in Bangalore delivering measurable ROI through Google Ads, Meta Ads, and data-driven paid media campaigns.',
  robots: {
    index: true,
    follow: true,
  ...
  alternates: {
    canonical: 'https://thebrandthink.com/performance-marketing-agency-in-bangalore/',
  },
  openGraph: {
    locale: 'en_US',
    type: 'article',
    ...
    description:
      'Top performance marketing agency in Bangalore delivering measurable ROI through Google Ads, Meta Ads, and data-driven paid media campaigns.',
    url: 'https://thebrandthink.com/performance-marketing-agency-in-bangalore/',
    siteName: 'BrandThink',
    images: [
      {
